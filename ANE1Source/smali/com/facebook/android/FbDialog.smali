...
.method private callDialogListener(Landroid/os/Bundle;Lcom/facebook/FacebookException;)V
    ...
    invoke-interface {v4, p1}, Lcom/facebook/android/Facebook$DialogListener;->onComplete(Landroid/os/Bundle;)V

    goto :goto_0

    .line 70
    :cond_1
    instance-of v4, p2, Lcom/facebook/FacebookDialogException;
    ...
    invoke-virtual {v2}, Lcom/facebook/FacebookDialogException;->getFailingUrl()Ljava/lang/String;
    ...
    invoke-interface {v4}, Lcom/facebook/android/Facebook$DialogListener;->onCancel()V
