...
public class AppEntry extends Activity
{
    ...
    private static final String RESOURCE_CLASS = "air.com.sixminute.ANE1Test.debug.R";
    ...
    private transient Object InvokeMethod(Method method, Object aobj[])
    {
        ...
        if (aobj != null)
        {
            ...
            try
            {
                obj = method.invoke(sAndroidActivityWrapper, aobj);
            }
            catch (Exception exception) { }
            break MISSING_BLOCK_LABEL_47;
        }
        obj1 = method.invoke(sAndroidActivityWrapper, new Object[0]);
        obj = obj1;
        return obj;
    }
...
label0:
    ...
    private void launchMarketPlaceForAIR()
    {
        ...
        if (s1 == null)
        {
            s1 = (new StringBuilder()).append("market://details?id=").append(RUNTIME_PACKAGE_ID).toString();
        }
        try
        {
    ...
    {
        ResourceIdMap resourceidmap = new ResourceIdMap("air.com.sixminute.ANE1Test.debug.R");
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        Log.i("StartupTime1", (new StringBuilder()).append(":").append(l).toString());
