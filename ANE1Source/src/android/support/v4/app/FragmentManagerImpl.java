...
final class FragmentManagerImpl extends FragmentManager
{
    ...
    public int allocBackStackIndex(BackStackRecord backstackrecord)
    {
        ...
        return i;
        int j;
        j = ((Integer)mAvailBackStackIndices.remove(mAvailBackStackIndices.size() - 1)).intValue();
        if (DEBUG)
        {
...
label1:
            do
            {
                ...
                do
                {
                    ...
                    break label1;
                } while (s != null && s.equals(backstackrecord2.getName()) || i >= 0 && i == backstackrecord2.mIndex);
                k--;
            } while (true);
            if ((j & 1) != 0)
            {
        ...
        for (int l = mBackStack.size() - 1; l > k; l--)
        {
