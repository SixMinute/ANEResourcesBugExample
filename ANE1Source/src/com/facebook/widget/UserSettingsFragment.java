...
public class UserSettingsFragment extends FacebookFragment
{
    ...
    private void processImageResponse(String s, ImageResponse imageresponse)
    {
        if (imageresponse != null)
        {
            ...
            if (bitmap != null)
            {
                ...
                bitmapdrawable.setBounds(0, 0, getResources().getDimensionPixelSize(com.facebook.android.R.dimen.com_facebook_usersettingsfragment_profile_picture_width), getResources().getDimensionPixelSize(com.facebook.android.R.dimen.com_facebook_usersettingsfragment_profile_picture_height));
    ...
    {
        View view = layoutinflater.inflate(com.facebook.android.R.layout.com_facebook_usersettingsfragment, viewgroup, false);
        loginButton = (LoginButton)view.findViewById(com.facebook.android.R.id.com_facebook_usersettingsfragment_login_button);
        ...
        connectedStateLabel = (TextView)view.findViewById(com.facebook.android.R.id.com_facebook_usersettingsfragment_profile_name);
