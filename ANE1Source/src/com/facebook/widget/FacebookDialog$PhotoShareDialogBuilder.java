...
public static class init> extends init>
{
    ...
    {
        return super.etApplicationName(s);
    }

    public volatile etApplicationName setFragment(Fragment fragment)
    {
        return super.etFragment(fragment);
    }

    public volatile etFragment setFriends(List list)
    {
    ...
    public volatile etPlace setRequestCode(int i)
    {
        return super.etRequestCode(i);
    }
