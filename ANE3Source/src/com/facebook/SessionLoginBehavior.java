...
public final class SessionLoginBehavior extends Enum
{
    ...
    static 
    {
        ...
        SessionLoginBehavior asessionloginbehavior[] = new SessionLoginBehavior[3];
        asessionloginbehavior[0] = SSO_WITH_FALLBACK;
        asessionloginbehavior[1] = SSO_ONLY;
        asessionloginbehavior[2] = SUPPRESS_SSO;
        ENUM$VALUES = asessionloginbehavior;
    }
}
