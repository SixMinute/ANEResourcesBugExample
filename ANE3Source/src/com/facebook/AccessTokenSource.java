...
public final class AccessTokenSource extends Enum
{
    ...
    static 
    {
        ...
        AccessTokenSource aaccesstokensource[] = new AccessTokenSource[7];
        aaccesstokensource[0] = NONE;
        aaccesstokensource[1] = FACEBOOK_APPLICATION_WEB;
        aaccesstokensource[2] = FACEBOOK_APPLICATION_NATIVE;
        aaccesstokensource[3] = FACEBOOK_APPLICATION_SERVICE;
        aaccesstokensource[4] = WEB_VIEW;
        aaccesstokensource[5] = TEST_USER;
        aaccesstokensource[6] = CLIENT_TOKEN;
        ENUM$VALUES = aaccesstokensource;
    }
}
