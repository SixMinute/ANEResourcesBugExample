...
_L2:
        ...
        if (atimplbase != null)
        {
            ...
            if (mCurrentDownEvent != null && mPreviousUpEvent != null && flag6 && isConsideredDoubleTap(mCurrentDownEvent, mPreviousUpEvent, motionevent))
            {
                ...
                flag5 = false | mDoubleTapListener.mDoubleTapListener(mCurrentDownEvent) | mDoubleTapListener.(motionevent);
            } else
            {
        ...
        return flag5 | mListener.mListener(motionevent);
_L4:
        float f6;
        float f7;
...
_L13:
        boolean flag4 = mListener.mListener(mCurrentDownEvent, motionevent, f6, f7);
        mLastFocusX = f2;
        mLastFocusY = f3;
        return flag4;
_L3:
...
_L14:
        boolean flag2 = false | mDoubleTapListener.(motionevent);
_L18:
...
_L19:
        flag2 = mListener.mListener(motionevent);
...
_L22:
        flag2 = mListener.mListener(mCurrentDownEvent, motionevent, f5, f4);
          goto _L18
_L5:
        cancel();
        return false;
