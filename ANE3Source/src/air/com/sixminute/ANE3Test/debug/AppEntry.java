...
public class AppEntry extends Activity
{
    ...
    private static final String RESOURCE_CLASS = "air.com.sixminute.ANE3Test.debug.R";
...
label0:
    ...
    {
        ResourceIdMap resourceidmap = new ResourceIdMap("air.com.sixminute.ANE3Test.debug.R");
