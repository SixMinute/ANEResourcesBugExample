...
.method protected onMeasure(II)V
    ...
    .line 483
    const-string v27, "SlidingPaneLayout"

    const-string v28, "onMeasure: More than two child views are not supported."
    ...
    .end local v24           #widthRemaining:I
    :cond_3
    if-nez v23, :cond_0
    ...
    .restart local v24       #widthRemaining:I
    :cond_7
    ...
    .end local v21           #skippedFirstPass:Z
    :cond_14
    const/16 v27, 0x0
    ...
    .line 562
    .restart local v21       #skippedFirstPass:Z
    :cond_15
    invoke-virtual {v5}, Landroid/view/View;->getMeasuredWidth()I
    ...
    .end local v19           #measuredWidth:I
    .end local v21           #skippedFirstPass:Z
    .end local v26           #widthToDistribute:I
    :cond_1e
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/support/v4/widget/ViewDragHelper;->getViewDragState()I
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/support/v4/widget/ViewDragHelper;->abort()V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1178
    iget-boolean v2, v1, Landroid/support/v4/widget/SlidingPaneLayout$SavedState;->isOpen:Z
...
.method smoothSlideTo(FI)Z
    ...
    invoke-virtual {v3, v4, v2, v5}, Landroid/support/v4/widget/ViewDragHelper;->smoothSlideViewTo(Landroid/view/View;II)Z
