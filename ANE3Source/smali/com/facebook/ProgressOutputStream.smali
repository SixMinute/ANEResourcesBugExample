...
.method private reportBatchProgress()V
    ...
    .line 57
    iget-object v2, p0, Lcom/facebook/ProgressOutputStream;->requests:Lcom/facebook/RequestBatch;

    invoke-virtual {v2}, Lcom/facebook/RequestBatch;->getCallbacks()Ljava/util/List;
    ...
    check-cast v7, Lcom/facebook/RequestBatch$Callback;

    .line 58
    .local v7, callback:Lcom/facebook/RequestBatch$Callback;
    instance-of v2, v7, Lcom/facebook/RequestBatch$OnProgressCallback;
    ...
    invoke-virtual {v2}, Lcom/facebook/RequestBatch;->getCallbackHandler()Landroid/os/Handler;

    move-result-object v8

    .line 62
    .local v8, callbackHandler:Landroid/os/Handler;
    move-object v0, v7
    ...
    .line 63
    .local v1, progressCallback:Lcom/facebook/RequestBatch$OnProgressCallback;
    if-nez v8, :cond_3

    .line 64
    iget-object v2, p0, Lcom/facebook/ProgressOutputStream;->requests:Lcom/facebook/RequestBatch;

    iget-wide v3, p0, Lcom/facebook/ProgressOutputStream;->batchProgress:J

    iget-wide v5, p0, Lcom/facebook/ProgressOutputStream;->maxProgress:J

    invoke-interface/range {v1 .. v6}, Lcom/facebook/RequestBatch$OnProgressCallback;->onBatchProgress(Lcom/facebook/RequestBatch;JJ)V
    ...
    invoke-direct {v2, p0, v1}, Lcom/facebook/ProgressOutputStream$1;-><init>(Lcom/facebook/ProgressOutputStream;Lcom/facebook/RequestBatch$OnProgressCallback;)V
